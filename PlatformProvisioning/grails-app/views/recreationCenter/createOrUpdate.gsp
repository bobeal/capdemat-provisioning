<html>
    <head>
         ...
         <title>Création/Modification de centres de loisirs</title>
    ...
    <body>
        <div class="body">
        	<g:if test="${mode == 'create'}">
				<h1>Création d'un centre de loisirs</h1>
        	</g:if>
        	<g:if test="${mode == 'update'}">
				<h1>Modification du centre de loisirs ${recCenter.name}</h1>
        	</g:if>
           ...
           <g:form action="save" method="post" >
               ...
               <g:if test="${mode == 'update'}" >
               		<input type="hidden" name="name" value="${recCenter.name}" />
               </g:if>
               <div class="dialog">
                <table>
                	<g:if test="${mode == 'create'}" >
							<tr class='prop'>
								...
								<td valign='top' style='text-align:left;' width='80%'> 
									<input type='text' id='name' name='name' value='${recCenter?.name}' 
					...
					<tr class='prop'>
						...
						<td valign='top' style='text-align:left;' width='80%'>
							<input type='text' id='address' name='address' value='${recCenter?.address}' 
					...
					<tr class='prop'>
						...
						<td valign='top' style='text-align:left;' width='80%'>
							<input type='text' id='telephoneNumber' name='telephoneNumber' 
								value='${recCenter?.telephoneNumber}' class='validate-phone'
					...
					<tr class='prop'>
						...
						<td valign='top' style='text-align:left;' width='80%'>
							<input type='text' id='email' name='email' 
								value='${recCenter?.email}' class='validate-email'
